"""Vouch command line.
    ...
    python3 -m vouch github-review review.json --repo owner/name --pr 5 --sha <head>   # inline comments on the PR
    python3 -m vouch app finish <code> --repo owner/name   # finish the GitHub App manifest flow (ui/app/index.html)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if argv and argv[0] == "app":
        from .github_app import main as app_main
